...
export default function Footer() {
  ...
  return (
    <div className="fixed items-center bottom-0 bg-black py-6 w-full h-20% bg-transparent pointer-events-none">
      <Container>
        <div className="grid grid-cols-3 ">
          ...
          <div className="flex space-x-6 justify-center pointer-events-auto">
            {isMuted ? (
              <NoMic
